...
export const GlareCardTwo = ({
  ...
  return (
    <div
      ...
      className="relative isolate [contain:layout_style] [perspective:600px] transition-transform duration-[var(--duration)] ease-[var(--easing)] delay-[var(--delay)] will-change-transform w-[300px] h-[160px]" // Increased width and decreased height
      ref={refElement}
      onPointerMove={(event) => {
